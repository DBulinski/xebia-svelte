...
declare module '$env/static/private' {
	...
	export const npm_config__beamery_registry: string;
	...
	export const npm_config___verdaccio_support_beamery_engineer__always_auth: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_config__beamery_registry: string;
		TMPDIR: string;
		...
		COMMAND_MODE: string;
		npm_config___verdaccio_support_beamery_engineer__always_auth: string;
